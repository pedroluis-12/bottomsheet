...
class MenuFragment : Fragment()  {
    ...
    ViewGroup?,
        ...
        val v = inflater.inflate(R.layout.fragment_menu, container,
            false)
        when (pos) {
            "0" -> {
                val imageList =
                    listOf<Int>(R.drawable.ic_local_gas_station_grey_700_24dp,
                ...
                val menuAdapter =
                    MenuAdapter(activity!!.applicationContext, imageList)
